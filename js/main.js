...
// function getLikesObject (id, likeId) {
//     let likesObj = getLikesObj(id);
//     return likesObj.likes.find(item => item.id === likeId); //вернет объект, если нет, то undefined
// };

// function checkOwnerLikes (id) {
//     let likesObj = getLikesObject(id)
//     return likesObj.user === inSystem //true true 
// }
